...
Use the Railway ops agent plus GitHub Issues for always-on monitoring.

Use Codex to work the issues and create reviewed fixes.

Do not use Cursor SDK in v1.

## Why

The always-on job needs reliable monitoring, durable state, Slack reports, and issue creation. Deterministic code is better for that than a coding agent loop.
...
- Five real issues have gone through intake to proof packet.
